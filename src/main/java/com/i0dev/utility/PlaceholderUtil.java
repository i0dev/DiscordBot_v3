    ...
    public static String convert(String message, User user, User author) {
        ...
        if (user != null) {
            ...
            message = message
                    ...
                    .replace("{muted}", dPlayer.isMuted() ? "Yes" : "No")
                    .replace("{muteExpiry}", dPlayer.getUnmuteAtTime() == 0 ? "`Not Muted`" : dPlayer.getUnmuteAtTime() == -1 ? "`Never`" : "<t:" + dPlayer.getUnmuteAtTime() / 1000 + ":R>")
                    ...
                    .replace("{ign}", dPlayer.getMinecraftIGN().equals("") || dPlayer.getMinecraftIGN().equalsIgnoreCase("0") ? "Not Linked" : dPlayer.getMinecraftIGN())
